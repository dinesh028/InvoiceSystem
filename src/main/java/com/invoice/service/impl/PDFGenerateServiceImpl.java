...
public class PDFGenerateServiceImpl implements PDFGenerateService {
	...
	public void generate(Set<InvoiceDetail> invoiceDetailSet,
			Invoice invoice) {

		
		//Member mem = (Member) session.getAttribute("login");
		String img = "D:/Impetus/Impetus Prj/InvoiceSystem/src/main/webapp/images/" + invoice.getClient().getTenant().getEmailId()
				+ ".jpg";
		System.out.println("img" + img);
		String fileName = "C:/prj/pdf/Invoice" + invoice.getInvoiceId()
				+ ".pdf";
		try {
			...
			Iterator<InvoiceDetail> it = invoiceDetailSet.iterator();
			InvoiceDetail ih = null;
			while (it.hasNext()) {
				ih = (InvoiceDetail) it.next();
