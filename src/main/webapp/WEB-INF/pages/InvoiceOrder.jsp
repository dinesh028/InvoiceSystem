...
<br>
	...
	<table id="itemTable">
		<tr>
			...
			<td>Invoice ID</td>
			<td><label name="invoiceid">${invoice.invoiceId}</label>
			</td>
...
<tr>
			...
			<c:choose>
      		...
      		<td>	<select id="datepicker1" onchange="changeDate(this.id)">
					<option value="0">-----Select----- </option>
    				<c:forEach begin="01" end="31" var="val">
    				
    						<option value="${val}"> ${val} </option>
					</c:forEach>
    			</select>&nbsp;&nbsp;&nbsp;&nbsp;(If send date is less than current date then it will be of next month)</td>
										...
										<table>
											...
											<p>
												...
												<td><input type="text" readonly=true
													id="itemQuantity_0" onkeyup="amountCalc(0)"
									...
									<table>
										...
										<tr>
											...
											<td><input type="text" id="iTax" name="iAmount"
												placeholder="Tax" value="2" size="20" onkeyup="calcTax()">
											</td>
										</tr>
										<tr>
											<td>Net Amount</td>
